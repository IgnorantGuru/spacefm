...
void on_popup_show_hidden( GtkMenuItem *menuitem, PtkFileBrowser* browser )
{
    if ( browser )
                                        ...
                                        GtkAccelGroup* accel_group )
{
    ...
    set = xset_set_cb( "view_thumb", main_window_toggle_thumbnails_all_windows,
                                                                NULL );
...
{   // either desktop or browser must be non-NULL
    ...
    else if ( desktop )
    {
        ...
        ptk_location_view_dev_menu( GTK_WIDGET( desktop ),
                                    GTK_WIDGET( desktop ), NULL, submenu );
#ifndef HAVE_HAL
