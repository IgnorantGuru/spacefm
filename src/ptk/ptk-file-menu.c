        ...
        if ( path )
        {
            if ( !g_file_test( path, G_FILE_TEST_EXISTS ) )
            {
                ...
                if ( file )
                {
                    ...
                    fprintf( file, "<?xml version='1.0' encoding='utf-8'?>\n<mime-info xmlns='http://www.freedesktop.org/standards/shared-mime-info'>\n\n<!-- This file was generated by SpaceFM to extend the definition of mime type\n     %s\n     For help editing this file:\n     http://www.freedesktop.org/wiki/Specifications/AddingMIMETutor\n     http://library.gnome.org/admin/system-admin-guide/stable/mimetypes-source-xml.html.en\n\n     IMPORTANT:  After saving this file you must run:\n     \n         update-mime-database ~/.local/share/mime\n-->\n\n<mime-type type=\"%s\">\n\n<comment>mime type %s</comment>\n<comment xml:lang=\"en\">mime type %s</comment>\n<!-- insert more translated comments here -->\n\n<!-- example to detect PNG file by glob pattern -->\n<!--\n    <glob pattern=\"*.png\"/>\n-->\n\n<!-- example to detect PNG file by file contents -->\n<!--\n    <magic priority=\"50\">\n        <match type=\"string\" value=\"\\x89PNG\" offset=\"0\"/>  \n    </magic>\n-->\n</mime-type>\n\n</mime-info>\n\n", str, str, str, str );
                    fclose( file );
                }
            }
            if ( g_file_test( path, G_FILE_TEST_EXISTS ) )
                                                    ...
                                                    guint button, guint32 time )
{
    ...
    if ( desktop_file->file_name )
    {
        ...
        if ( g_file_test( path, G_FILE_TEST_EXISTS ) )
        {
            str = g_strdup_printf( "/_home %s", desktop_file->file_name );
            icon = GTK_STOCK_EDIT;
        }
        else
        {
            str = g_strdup_printf( "/_home %s (%s)", desktop_file->file_name,
                                                                    _("missing") );
            icon = GTK_STOCK_NEW;
        }
    ...
    if ( desktop_file->file_name )
    {
        str = g_strdup_printf( "/_usr %s", desktop_file->file_name );
        newitem = app_menu_additem( app_menu, str,
    ...
    // Mime
    newitem = app_menu_additem( app_menu, "/home mime/pac_kages/",
